...
function ForgotPasswordPage() {
  ...
  const visiblePasswordErrors = newPassword || submitted ? passwordErrors : [];
  const visibleConfirmError =
    confirmPassword || submitted
      ? confirmError || (!confirmPassword ? "Confirm Password is required" : "")
      : "";
  ...
  const handleConfirm = async (event) => {
    ...
    try {
      // TODO: connect reset password API/backend
        ...
        <form onSubmit={handleConfirm} className="space-y-5">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="flex h-[52px] items-center justify-center gap-2 rounded-lg bg-blue-600 text-base font-semibold text-white shadow-lg shadow-blue-600/25 transition hover:bg-blue-700 disabled:cursor-not-allowed disabled:bg-blue-400"
            >
              <KeyRound size={20} />
            ...
            <button
              ...
              disabled={loading}
              className="flex h-[52px] items-center justify-center gap-2 rounded-lg border border-gray-200 bg-white text-base font-semibold text-gray-700 transition hover:bg-gray-50 disabled:cursor-not-allowed disabled:text-gray-400"
            >
              <X size={20} />
              Cancel
            </button>
